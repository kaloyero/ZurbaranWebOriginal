...
<div class="contNew modal hide fade" id="modal-simple">
	<div class="innerLR">
		...
		<form id="validateSubmitForm" style="margin-bottom: 0;" novalidate="novalidate" class="contFormNew form-horizontal" action="/ZurbaranWeb/cuenta/show" method="get" autocomplete="off">
