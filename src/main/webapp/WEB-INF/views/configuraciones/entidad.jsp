...
<div class="contNew modal hide fade" id="modal-simple">
	...
	<!-- Form -->
	<form:form commandName="Entidad" class="contFormNew form-horizontal" style="margin-bottom: 0;" id="validateSubmitForm" method="get" autocomplete="off" novalidate="novalidate">
		...
		<div class="widget">
			...
			<div class="widget-body">
				...
				<div class="form-actions">
					<button type="submit" class="save btn btn-icon btn-primary glyphicons circle_ok"><i></i>Guardar</button>
